                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="relative">
                        <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                            <video src={heroVideo} poster={finbugLogo} className="w-full h-full object-cover" autoPlay loop muted playsInline preload="metadata">
                                <img src={finbugLogo} alt="FinBug Demo" className="w-full h-full object-cover" loading="lazy" />
                            </video>
                        </div>
                    </div>
                </div>
